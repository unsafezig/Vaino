...
// Onko kuvaaja I/O-valmis ring-3-polulla VSL-2:ssa?
// Konsoli kyllä (UART-syscallit 1/11); file ei vielä (ei fd-syscalleja
// kernelissä) — boot-testi todistaa VFS-polun kernel-puolella. Ei valehtelua.
pub fn isIoReady(fd: u32) bool {
    ...
    return switch (k) {
        ...
        .console => true,
        // Tiedosto-I/O odottaa kernelin fd-syscalleja (VSL-4).
        .file => false,
